...
class CryptoClicker:
    ...
    def open_withdraw_window(self):
        ...
        self.withdraw_window = pygame_gui.elements.UIWindow(
            rect=pygame.Rect((60, WINDOW_HEIGHT//2 - 160), (520, 320)),
            manager=self.ui_manager,
        ...
        self.withdraw_addr_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y), (160, 24)), text='Address', manager=self.ui_manager, container=inner
        )
        self.withdraw_address_input = pygame_gui.elements.UITextEntryLine(
            relative_rect=pygame.Rect((180, y), (300, 28)), manager=self.ui_manager, container=inner
        )
        
        y += 38
        self.withdraw_memo_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y), (160, 24)), text='Memo/Tag', manager=self.ui_manager, container=inner
        )
        ...
        self.withdraw_network_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y), (160, 24)), text='Network', manager=self.ui_manager, container=inner
        )
        self.withdraw_network_dropdown = pygame_gui.elements.UIDropDownMenu(
            options_list=['TRC20', 'ERC20'], starting_option='TRC20',
            relative_rect=pygame.Rect((180, y), (140, 28)), manager=self.ui_manager, container=inner
        )
        y += 38
        self.withdraw_amount_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y), (160, 24)), text='Amount ($)', manager=self.ui_manager, container=inner
        )
        ...
        self.withdraw_fee_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y), (460, 24)), text='Fee: 1.55 (TRC20) or 10.00 (ERC20)', manager=self.ui_manager, container=inner
        )
        y += 50
        self.withdraw_confirm_btn = pygame_gui.elements.UIButton(
            relative_rect=pygame.Rect((20, y), (200, 36)), text='Confirm Withdraw', manager=self.ui_manager, container=inner
        )
        self.withdraw_cancel_btn = pygame_gui.elements.UIButton(
            relative_rect=pygame.Rect((240, y), (160, 36)), text='Cancel', manager=self.ui_manager, container=inner
        )
        self.withdraw_status_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y+44), (460, 24)), text='', manager=self.ui_manager, container=inner
        )
        
        # НЕМЕДЛЕННАЯ установка значений после создания всех элементов
    ...
    def handle_events(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame_gui.UI_BUTTON_PRESSED:
                    ...
                    if needs_create:
                        ...
                        if getattr(self.history_window, 'visible', False):
                            ...
                            try:
                                ...
                                pass
                elif getattr(self, 'history_save_btn', None) is not None and event.ui_element == self.history_save_btn:
                ...
                elif getattr(self, 'history_close_btn', None) is not None and event.ui_element == self.history_close_btn:
                    # Закрыть окно истории
                    try:
                        self.history_window.hide()
                    except Exception:
                        pass
                elif hasattr(self, 'withdraw_button') and event.ui_element == self.withdraw_button:
                    # Открываем окно вывода по нажатию кнопки Withdraw
                    self.open_withdraw_window()
                elif getattr(self, 'withdraw_confirm_btn', None) is not None and event.ui_element == self.withdraw_confirm_btn:
                    self.handle_withdraw_confirm()
                elif getattr(self, 'withdraw_cancel_btn', None) is not None and event.ui_element == self.withdraw_cancel_btn:
                    self.close_withdraw_window()
            # Roulette controls
                elif hasattr(self, 'roulette_bet_red_btn') and event.ui_element == self.roulette_bet_red_btn:
                    ...
                    if amt > 0:
                        ...
                        if amt <= remaining:
                            ...
                            try:
                                ...
                                pass
                elif hasattr(self, 'roulette_bet_black_btn') and event.ui_element == self.roulette_bet_black_btn:
                    amt_txt = self.roulette_bet_amount_input.get_text().strip() if hasattr(self, 'roulette_bet_amount_input') else '0'
                    try:
                        amt = float(amt_txt)
                    except Exception:
                    ...
                    if amt > 0:
                        ...
                        if amt <= remaining:
                            ...
                            try:
                                ...
                                pass
                elif hasattr(self, 'roulette_bet_zero_btn') and event.ui_element == self.roulette_bet_zero_btn:
                    amt_txt = self.roulette_bet_amount_input.get_text().strip() if hasattr(self, 'roulette_bet_amount_input') else '0'
                    try:
                        amt = float(amt_txt)
                    except Exception:
                    ...
                    if amt > 0:
                        ...
                        if amt <= remaining:
                            ...
                            try:
                                ...
                                pass
                elif hasattr(self, 'roulette_spin_btn') and event.ui_element == self.roulette_spin_btn:
            ...
            if event.type == pygame_gui.UI_FILE_DIALOG_PATH_PICKED:
                if getattr(self, 'history_save_dialog', None) is not None and event.ui_element == self.history_save_dialog:
            ...
            if event.type == pygame_gui.UI_WINDOW_CLOSE:
                if getattr(self, 'history_save_dialog', None) is not None and event.ui_element == self.history_save_dialog:
                    ...
                    try:
                        ...
                        pass
                if getattr(self, 'drive_window', None) is not None and event.ui_element == self.drive_window:
                    ...
                    try:
                        ...
                        pass
                if getattr(self, 'manual_save_window', None) is not None and event.ui_element == self.manual_save_window:
            ...
            if event.type == pygame_gui.UI_BUTTON_PRESSED:
                ...
                if getattr(self, 'drive_buttons', None):
                    if event.ui_element in self.drive_buttons:
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        pass
                if getattr(self, 'manual_save_confirm_btn', None) is not None and event.ui_element == self.manual_save_confirm_btn:
                    ...
                    try:
                        ...
                        pass
                if getattr(self, 'manual_save_cancel_btn', None) is not None and event.ui_element == self.manual_save_cancel_btn:
    ...
    def open_withdraw_window(self):
        ...
        y += 38
        self.withdraw_fee_label = pygame_gui.elements.UILabel(
            relative_rect=pygame.Rect((20, y), (460, 24)), text='Fee: .55 (TRC20) or .00 (ERC20)', manager=self.ui_manager, container=inner
        )
        y += 50
        self.withdraw_confirm_btn = pygame_gui.elements.UIButton(
            relative_rect=pygame.Rect((20, y), (200, 36)), text='Confirm Withdraw', manager=self.ui_manager, container=inner
    ...
    def handle_withdraw_confirm(self):
        ...
        if self.balance < total:
            try:
                self.withdraw_status_label.set_text(f'Insufficient balance. Need , have ')
            except Exception:
                pass
            return
        self.balance -= total
        try:
            self.balance_label.set_text(f"Balance: ")
            self.withdraw_status_label.set_text(f'Sent  via {net}, fee . Memo/Tag: {memo}')
        except Exception:
            pass
        self.close_withdraw_window()
    ...
    def close_withdraw_window(self):
        ...
        self.withdraw_addr_label = None
        self.withdraw_address_input = None
        self.withdraw_memo_label = None
        self.withdraw_memo_input = None
        self.withdraw_network_label = None
        self.withdraw_network_dropdown = None
        self.withdraw_amount_label = None
        self.withdraw_amount_input = None
        self.withdraw_fee_label = None
        self.withdraw_confirm_btn = None
        self.withdraw_cancel_btn = None
        self.withdraw_status_label = None
